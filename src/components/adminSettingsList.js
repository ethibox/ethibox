            ...
            { settings.map(({ name, value }, index) => {
                    ...
                    return (
                        <div key={name} className="col-span-2 sm:col-span-1">
                            ...
                            <select
                                ...
                                className="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:border-gray-300 sm:text-sm rounded-md appearance-none focus:outline-none focus:shadow-outline-none focus:ring-0"
                            >
                ...
                return (
                    <div key={name} className="col-span-2 sm:col-span-1">
                        ...
                        <input
                            id={decamelize(name, '_')}
                            className="mt-1 w-full py-2 px-3 border border-gray-300 rounded-md focus:border-gray-300 focus:outline-none focus:shadow-outline-none focus:ring-0 sm:text-sm sm:leading-5"
                            name={name}
                            value={value}
